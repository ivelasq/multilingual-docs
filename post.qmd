...
[Quarto](https://quarto.org/) is a multilingual authoring system by Posit, and its built-in support for multiple programming languages makes it an excellent choice for developers, technical writers, and educators looking to create flexible, multilingual documentation. Below, we'll explore two approaches to implement this functionality:
...
The [Tabby extension](https://quarto.thecoatlessprofessor.com/tabby/) by Coatless provides another way to create multilingual documentation.
